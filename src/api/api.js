...
const API_BASE_URL = 'https://market.stockglobalmarket.com/api';
const API = 'https://market.stockglobalmarket.com';
...
export const ENDPOINTS = {
    ...
    WITHDRAWS_SUCCESS: (pk) => `${API_BASE_URL}/withdraws/${pk}/success/`,
